...
% Редакционная заметка (используется в chapters/)
\newenvironment{editorialnote}
  {\par\medskip\noindent\textbf{Примечание редакции.}\begin{itshape}\small}
  {\end{itshape}\par\smallskip}
% Алиасы, используемые в главах
\providecommand{\EditorInChief}[1]{\PrintEditorInChief{#1}}
% Алиасы имён авторов статей (используются в articles/*)
\providecommand{\Editor}[1]{\PrintEditorInChief{#1}}
